...
.venv/bin/python ./src/backend/fastapi_app/setup_postgres_legal_seeddata_msrgraphrag.py --host $POSTGRES_HOST --username $POSTGRES_USERNAME --database $POSTGRES_DATABASE
